...
class Pagination extends \JPagination
{
    ...
    public function getPagesLinks($listRef = 0, $tmpl = 'default')
    {
        ...
        if ($data->all->base !== null)
        {
            ...
            $list['all']['data'] = $itemOverride ? fabrik_pagination_item_active($data->all,
                $this->listRef) : $this->_item_active($data->all);
        }
        else
        {
        ...
        if ($data->start->base !== null)
        {
            ...
            $list['start']['data'] = $itemOverride ? fabrik_pagination_item_active($data->start,
        ...
        foreach ($data->pages as $i => $page)
        {
            if ($page->base !== null)
            {
                ...
                $list['pages'][$i]['data'] = $itemOverride ? fabrik_pagination_item_active($page,
                    $this->listRef) : $this->_item_active($page);
            }
            else
            {
        ...
        if ($data->next->base !== null)
        {
            ...
            $list['next']['data'] = $itemOverride ? fabrik_pagination_item_active($data->next,
                $this->listRef) : $this->_item_active($data->next);
        }
        else
        {
        ...
        if ($data->end->base !== null)
        {
            ...
            $list['end']['data'] = $itemOverride ? fabrik_pagination_item_active($data->end,
                $this->listRef) : $this->_item_active($data->end);
        }
        else
        {
