                    ...
                    while ($this->getEBMLelement($element_data, $top_element['end']))
                    {
                        ...
                        switch ($element_data['id'])
                        {
                                    ...
                                    switch ($track_entry['id'])
                                    {
                                        ...
                                        case EBML_ID_TRACKENTRY: //subelements: Describes a track with all elements.
                                            ...
                                            while ($this->getEBMLelement($subelement, $track_entry['end'],
                                                [EBML_ID_VIDEO, EBML_ID_AUDIO, EBML_ID_CONTENTENCODINGS, EBML_ID_CODECPRIVATE]))
                                            {
                                                            ...
                                                            switch ($sub_subelement['id'])
                                                            {
                                                                ...
                                                                case EBML_ID_CONTENTENCODING:
                                                                    ...
                                                                    while ($this->getEBMLelement($sub_sub_subelement,
                                                                        $sub_subelement['end'],
                                                                        [EBML_ID_CONTENTCOMPRESSION, EBML_ID_CONTENTENCRYPTION]))
                                                                    {
                                                ...
                                                [EBML_ID_CHAPTERATOM]))
                                            {
                                                switch ($sub_subelement['id'])
                                                {
                                                    ...
                                                    case EBML_ID_CHAPTERATOM:
                                                        ...
                                                        while ($this->getEBMLelement($sub_sub_subelement,
                                                            $sub_subelement['end'],
                                                            [EBML_ID_CHAPTERTRACK, EBML_ID_CHAPTERDISPLAY]))
                                                        {
                                                            switch ($sub_sub_subelement['id'])
                                                            {
                            ...
                            case EBML_ID_CLUSTER: // The lower level element containing the (monolithic) Block structure.
                                ...
                                while ($this->getEBMLelement($subelement, $element_data['end'],
                                    [EBML_ID_CLUSTERSILENTTRACKS, EBML_ID_CLUSTERBLOCKGROUP, EBML_ID_CLUSTERSIMPLEBLOCK]))
                                {
                                    switch ($subelement['id'])
                                    {
