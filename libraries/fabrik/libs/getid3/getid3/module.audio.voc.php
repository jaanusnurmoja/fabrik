...
class getid3_voc extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        {
            $info['error'][] = 'Expecting "' . getid3_lib::PrintHexBytes($magic) . '" at offset ' . $info['avdataoffset'] . ', found "' . getid3_lib::PrintHexBytes(substr($VOCheader,
                    0, 19)) . '"';
            return false;
        }
        ...
        do
        {
            ...
            switch ($BlockType)
            {
                ...
                case 1:  // Sound data
                    ...
                    {
                        $thisfile_voc['compressed_bits_per_sample'] = getid3_lib::CastAsInt(str_replace('-bit', '',
                            $ThisBlock['compression_name']));
                    }
