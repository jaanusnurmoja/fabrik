    ...
    public function Analyze()
    {
        ...
        for ($i = 0; $i < $thisfile_ape['footer']['raw']['tag_items']; $i++)
        {
            ...
            switch (strtolower($item_key))
            {
                ...
                case 'mp3gain_undo':
                    if (
                    preg_match('#^[\\-\\+][0-9]{3},[\\-\\+][0-9]{3},[NW]$#', $thisfile_ape_items_current['data'][0])
                    )
                    {
                ...
                case 'cover art (studio)':
                    ...
                    do
                    {
                        ...
                        $imageinfo = [];
                        $imagechunkcheck = getid3_lib::GetDataImageSize($thisfile_ape_items_current['data'],
                            $imageinfo);
                        ...
                        {
                            $this->inline_attachments = rtrim(str_replace(['/', '\\'], DIRECTORY_SEPARATOR,
