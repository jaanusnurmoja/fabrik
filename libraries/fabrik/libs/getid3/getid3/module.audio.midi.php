                    ...
                    elseif (($MIDIevents[$tracknumber][$eventid]['eventid'] == 0x0F) && ($MIDIevents[$tracknumber][$eventid]['channel'] == 0x0F))
                    {
                        ...
                        switch ($METAeventCommand)
                        {
                            case 0x00: // Set track sequence number
                                $track_sequence_number = getid3_lib::BigEndian2Int(substr($METAeventData, 0,
                                    $METAeventLength));
                            ...
                            case 0x51: // Tempo: microseconds / quarter note
                                $CurrentMicroSecondsPerBeat = getid3_lib::BigEndian2Int(substr($METAeventData, 0,
                                    $METAeventLength));
                            ...
                            case 0x58: // Time signature
                                ...
                                $timesig_denominator = pow(2,
                                    getid3_lib::BigEndian2Int($METAeventData{1})); // $02 -> x/4, $03 -> x/8, etc
