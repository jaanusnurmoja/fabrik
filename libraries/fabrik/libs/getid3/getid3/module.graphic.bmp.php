    ...
    public function Analyze()
    {
        ...
        if ($thisfile_bmp['type_os'] == 'OS/2')
        {
            ...
            if ($thisfile_bmp['type_version'] >= 2)
            {
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['bmp_data_size'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset,
                    4));
                $offset += 4;
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['colors_important'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset,
                    4));
                $offset += 4;
                $thisfile_bmp_header_raw['resolution_units'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset,
                    2));
                $offset += 2;
                $thisfile_bmp_header_raw['reserved1'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset, 2));
                $offset += 2;
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['color_encoding'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset,
                    4));
                $offset += 4;
        ...
        elseif ($thisfile_bmp['type_os'] == 'Windows')
        {
            ...
            if ($thisfile_bmp['type_version'] >= 5)
            {
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['profile_data_offset'] = getid3_lib::LittleEndian2Int(substr($BMPheader,
                    $offset, 4));
                $offset += 4;
                $thisfile_bmp_header_raw['profile_data_size'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset,
                    4));
                $offset += 4;
                    ...
                    switch ($thisfile_bmp_header_raw['bits_per_pixel'])
                    {
                        case 8:
                            ...
                            while ($pixeldataoffset < strlen($BMPpixelData))
                            {
                                ...
                                $secondbyte = getid3_lib::LittleEndian2Int(substr($BMPpixelData, $pixeldataoffset++,
                                    1));
                                if ($firstbyte == 0)
                                {
                                    ...
                                    switch ($secondbyte)
                                    {
                                        ...
                                        case 2:
                                            ...
                                            $colincrement = getid3_lib::LittleEndian2Int(substr($BMPpixelData,
                                                $pixeldataoffset++, 1));
                                            $rowincrement = getid3_lib::LittleEndian2Int(substr($BMPpixelData,
                                                $pixeldataoffset++, 1));
                                        ...
                                        default:
                                            ...
                                            {
                                                $paletteindex = getid3_lib::LittleEndian2Int(substr($BMPpixelData,
                                                    $pixeldataoffset++, 1));
                                ...
                                if ($firstbyte == 0)
                                {
                                    ...
                                    switch ($secondbyte)
                                    {
                                        ...
                                        default:
                                            ...
                                            {
                                                $paletteindexbyte = getid3_lib::LittleEndian2Int(substr($BMPpixelData,
                                                    $pixeldataoffset++, 1));
                    ...
                    switch ($thisfile_bmp_header_raw['bits_per_pixel'])
                    {
                        ...
                        case 32:
                            ...
                            for ($row = ($thisfile_bmp_header_raw['height'] - 1); $row >= 0; $row--)
                            {
                                for ($col = 0; $col < $thisfile_bmp_header_raw['width']; $col++)
                                {
                                    $pixelvalue = getid3_lib::LittleEndian2Int(substr($BMPpixelData, $pixeldataoffset,
