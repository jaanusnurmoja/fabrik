                        ...
                        if (!empty($value))
                        {
                            ...
                            elseif ($tagtype == 'id3v1')
                            {
                                ...
                                foreach ($ThisFileInfo['comments'][$tagname] as $existingkey => $existingvalue)
                                {
                                    ...
                                    if (
                                        ($newvaluelength <= $oldvaluelength) && (substr($existingvalue, 0,
                            ...
                            elseif (!is_array($value))
                            {
                                ...
                                foreach ($ThisFileInfo['comments'][$tagname] as $existingkey => $existingvalue)
                                {
                                    $oldvaluelength = strlen(trim($existingvalue));
                                    if (
                                        (strlen($existingvalue) > 10) && ($newvaluelength > $oldvaluelength) && (substr(trim($value),
                            ...
                            if (
                                is_array($value) || empty($ThisFileInfo['comments'][$tagname]) || !in_array(trim($value),
