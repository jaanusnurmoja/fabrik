...
class VoiceResponse extends TwiML
{
     ...
     * @return TwiML Child element.
     */
    public function dial($number, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function enqueue($name = null, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function redirect($url, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function sms($message, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function prompt($attributes = [])
    {
