...
class Say extends TwiML
{
     ...
     */
    public function break_($attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function emphasis($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function lang($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function phoneme($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function prosody($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function say_As($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function sub($words, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function w($words, $attributes = [])
    {
