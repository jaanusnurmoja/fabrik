...
class Dial extends TwiML
{
     ...
     */
    public function __construct($number, $attributes = [])
    {
     ...
     */
    public function client($identity = null, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function conference($name, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function number($phoneNumber, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function queue($name, $attributes = [])
    {
     ...
     * @return TwiML Child element.
     */
    public function sip($sipUrl, $attributes = [])
    {
