...
class CapabilityToken
{
    ...
    public function addPolicyDeconstructed($url, $method, $queryFilter = [], $postFilter = [], $allow = true)
    {
    ...
    public function deny($url, $method, $queryFilter = [], $postFilter = [])
    {
    ...
    public function generateToken($ttl = 3600, $extraAttributes = [])
    {
        $payload = [
        ...
        elseif (substr($this->channelId, 0, 2) == 'WQ')
        {
