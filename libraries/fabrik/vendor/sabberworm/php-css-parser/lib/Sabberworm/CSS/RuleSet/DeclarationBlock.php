...
class DeclarationBlock extends RuleSet
{
    ...
    public function render(\Sabberworm\CSS\OutputFormat $oOutputFormat)
    {
        ...
        $sResult = $oOutputFormat->implode($oOutputFormat->spaceBeforeSelectorSeparator() . ',' . $oOutputFormat->spaceAfterSelectorSeparator(),
                $this->aSelectors) . $oOutputFormat->spaceBeforeOpeningBrace() . '{';
