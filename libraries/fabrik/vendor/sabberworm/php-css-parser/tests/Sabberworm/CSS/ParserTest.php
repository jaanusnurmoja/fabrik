    ...
    function testColorParsing()
    {
        ...
        foreach ($oDoc->getAllRuleSets() as $oRuleSet)
        {
            ...
            if ($sSelector === '#mine')
            {
                ...
                $oColor = $aColorRule[0]->getValue();
                $this->assertEquals(['r'                   => new Size(35.0, null, true,
                    $oColor->getLineNo()), 'g'             => new Size(35.0, null, true,
                    $oColor->getLineNo()), 'b'             => new Size(35.0, null, true, $oColor->getLineNo())
                ], $oColor->getColor());
                $aColorRule = $oRuleSet->getRules('border-color');
                $oColor = $aColorRule[0]->getValue();
                $this->assertEquals(['r'                   => new Size(10.0, null, true,
                    $oColor->getLineNo()), 'g'             => new Size(100.0, null, true,
                    $oColor->getLineNo()), 'b'             => new Size(230.0, null, true, $oColor->getLineNo())
                ], $oColor->getColor());
                $oColor = $aColorRule[1]->getValue();
                $this->assertEquals(['r'                   => new Size(10.0, null, true,
                    $oColor->getLineNo()), 'g'             => new Size(100.0, null, true,
                    $oColor->getLineNo()), 'b'             => new Size(231.0, null, true,
                    $oColor->getLineNo()), 'a'             => new Size("0000.3", null, true, $oColor->getLineNo())
                ], $oColor->getColor());
                $aColorRule = $oRuleSet->getRules('outline-color');
                $oColor = $aColorRule[0]->getValue();
                $this->assertEquals(['r'                   => new Size(34.0, null, true,
                    $oColor->getLineNo()), 'g'             => new Size(34.0, null, true,
                    $oColor->getLineNo()), 'b'             => new Size(34.0, null, true, $oColor->getLineNo())
                ], $oColor->getColor());
            }
            elseif ($sSelector === '#yours')
            {
                ...
                $oColor = $aColorRule[0]->getValue();
                $this->assertEquals(['h'                  => new Size(220.0, null, true,
                    $oColor->getLineNo()), 's'            => new Size(10.0, '%', true,
                    $oColor->getLineNo()), 'l'            => new Size(220.0, '%', true, $oColor->getLineNo())
                ], $oColor->getColor());
                $oColor = $aColorRule[1]->getValue();
                $this->assertEquals(['h'                  => new Size(220.0, null, true,
                    $oColor->getLineNo()), 's'            => new Size(10.0, '%', true,
                    $oColor->getLineNo()), 'l'            => new Size(220.0, '%', true,
                    $oColor->getLineNo()), 'a'            => new Size(0000.3, null, true, $oColor->getLineNo())
                ], $oColor->getColor());
            }
        }
