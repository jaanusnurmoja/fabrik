...
<select name="<?php
echo $d->name . '[year]'; ?>" class="input-small fabrik_filter" <?php
echo $data; ?> >
    <?php
    foreach ($d->years as $item) :
...
<select name="<?php
echo $d->name . '[month]'; ?>" class="input-small fabrik_filter" <?php
echo $data; ?> >
    <?php
    foreach ($d->months as $item) :
...
<select name="<?php
echo $d->name . '[day]'; ?>" class="input-small fabrik_filter" <?php
echo $data; ?> >
    <?php
    foreach ($d->days as $item) :
