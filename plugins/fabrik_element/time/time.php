        ...
        else
        {
            ...
            $hours = [
                JHTML::_('select.option', '',
                    $params->get('time_hourlabel', FText::_('PLG_ELEMENT_TIME_SEPARATOR_HOUR')))
            ];
            ...
            $mins = [
                JHTML::_('select.option', '',
                    $params->get('time_minlabel', FText::_('PLG_ELEMENT_TIME_SEPARATOR_MINUTE')))
            ];
            ...
            $secs = [
                JHTML::_('select.option', '',
                    $params->get('time_seclabel', FText::_('PLG_ELEMENT_TIME_SEPARATOR_SECOND')))
            ];
