...
if ($d->frontEndSelect && $d->editable) :
    ...
    ?>
    <a href="<?php
    echo $d->chooseUrl; ?>" class="toggle-selectoption btn" title="<?php
    echo FText::_('COM_FABRIK_SELECT'); ?>">
        <?php
        echo FabrikHelperHTML::image('search', 'form', @$d->tmpl, ['alt' => FText::_('COM_FABRIK_SELECT')]); ?>
    </a>
<?php
endif;
...
if ($d->frontEndAdd && $d->editable) :
    ...
    ?>
    <a href="<?php
    echo $d->addURL; ?>" title="<?php
    echo FText::_('COM_FABRIK_ADD'); ?>" class="toggle-addoption btn">
        <?php
        echo FabrikHelperHTML::image('plus', 'form', @$d->tmpl, ['alt' => FText::_('COM_FABRIK_SELECT')]); ?>
    </a>
<?php
endif;
// If add and select put them in a button group.
