...
class PlgFabrik_ElementLink extends PlgFabrik_Element
{
    ...
    public function render($data, $repeatCounter = 0)
    {
        ...
        if (!$this->isEditable())
        {
            ...
            $w = new FabrikWorker;
            $href = is_array($data) ? $w->parseMessageForPlaceHolder($href,
                $data) : $w->parseMessageForPlaceHolder($href);
    ...
    public function getDefaultValue($data = [])
    {
        if (!isset($this->default))
        {
            ...
            */
            ...
            $this->default = ['label' => $default, 'link' => $link];
        }
