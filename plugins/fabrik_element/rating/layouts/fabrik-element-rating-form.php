...
<div id="<?php
echo $d->id; ?>_div" class="fabrikSubElementContainer">
    <?php
    $imgOpts = ['icon-class' => 'small', 'style' => $d->css, 'data-rating' => -1];
    ...
    $imgOpts = ['icon-class' => 'starRating', 'style' => $d->css];
    ...
    ?>
    <span class="ratingScore badge badge-info"><?php
        echo $d->avg; ?></span>
    <div class="ratingMessage">
        &nbsp;
    </div>
    <input class="fabrikinput input" type="hidden" name="<?php
    echo $d->name; ?>" id="<?php
    echo $d->id; ?>" value="<?php
    echo $d->value; ?>"/>
</div>
