...
class PlgFabrik_ElementYesno extends PlgFabrik_ElementRadiobutton
{
     ...
     * @return  array
     */
    protected function getSubOptionValues($data = [])
    {
        return [0, 1];
    }
     ...
     * @return  array
     */
    protected function getSubOptionLabels($data = [])
    {
        return [FText::_('JNO'), FText::_('JYES')];
    }
    ...
    {
        $rows = [
            JHTML::_('select.option', '', $this->filterSelectLabel()), JHTML::_('select.option', '0', FText::_('JNO')),
