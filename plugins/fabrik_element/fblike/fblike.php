...
class PlgFabrik_ElementFblike extends PlgFabrik_Element
{
    ...
    public function renderListData($data, stdClass &$thisRow, $opts = [])
    {
        ...
        $str = FabrikHelperHTML::facebookGraphAPI($params->get('opengraph_applicationid'),
            $params->get('fblike_locale', 'en_US'), $meta);
    ...
    public function render($data, $repeatCounter = 0)
    {
        ...
        $str = FabrikHelperHTML::facebookGraphAPI($params->get('fblike_opengraph_applicationid'),
            $params->get('fblike_locale', 'en_US'), $meta);
    ...
    public function onAjax_rate()
    {
        ...
        $list->updateRows([$rowId], $field, null, $update);
    }
}
