...
class PlgFabrik_ElementCaptcha extends PlgFabrik_Element
{
    ...
    public function render($data, $repeatCounter = 0)
    {
        ...
        elseif ($params->get('captcha-method') == 'nocaptcha')
        {
            ...
            $displayData->lang = FabrikWorker::replaceWithLanguageTags(JString::strtolower($params->get('recaptcha_lang',
                'en')));
    ...
    public function onAjax_image()
    {
        ...
        {
            imageline($image, mt_rand(0, $imgWidth), mt_rand(0, $imgHeight), mt_rand(0, $imgWidth),
                mt_rand(0, $imgHeight), $noise_color);
        }
