...
class FlashRenderModel extends FabModel
{
    ...
    public function render(&$model, &$params, $file)
    {
        ...
        $displayData->useThumbs = !$model->inDetailedView && $fbConfig->get('use_mediabox',
                true) && $params->get('make_thumbnail', false);
        $displayData->width = $w;
     ...
     * @return  string  HTML
     */
    public function renderCarousel($id = 'carousel', $data = [], $model = null, $params = null, $thisRow = null, $nav = true)
    {
        $rendered = '';
        /**
         * @TODO - build it!
