...
class Amazons3storage extends FabrikStorageAdaptor
{
    ...
    public function __construct(&$params)
    {
        ...
        $this->s3 = new S3($params->get('fileupload_aws_accesskey'), $params->get('fileupload_aws_secretkey'),
            $this->ssl);
    ...
    public function getFileInfo($filepath)
    {
        ...
        $thisFileInfo = ['filesize' => $s3Info['size'], 'mime_type' => $s3Info['type'], 'filename' => basename($filepath)];
