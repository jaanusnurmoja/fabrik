...
class PlgFabrik_ListRadius_lookup extends PlgFabrik_List
{
    ...
    public function onMakeFilters(&$args)
    {
        ...
        $layoutData['vals'] = $this->app->input->get('radius_lookup' . $this->renderOrder, [], 'array');
        $layoutData['lat'] = $this->app->getUserStateFromRequest($baseContext . 'lat' . $this->renderOrder,
            'radius_search_lat' . $this->renderOrder);
        $layoutData['lon'] = $this->app->getUserStateFromRequest($baseContext . 'lon' . $this->renderOrder,
    ...
    protected function getQuery($params)
    {
        ...
        $lookUps = $input->get('radius_lookup' . $this->renderOrder, [], 'array');
    ...
    protected function getSearchLatLon()
    {
        ...
        $baseContext = $this->getSessionContext();
        $latitude = $app->getUserStateFromRequest($baseContext . 'lat' . $this->renderOrder,
            'radius_search_lat' . $this->renderOrder);
        $longitude = $app->getUserStateFromRequest($baseContext . 'lon' . $this->renderOrder,
            'radius_search_lon' . $this->renderOrder);
    ...
    public function onFiltersGot()
    {
        ...
        $app = JFactory::getApplication();
        $lookUps = $app->input->get('radius_lookup' . $this->renderOrder, [], 'array');
