...
$listData = $data['data'];
?>
<div id="radius_lookup<?php
echo $renderOrder; ?>">
    <input type="hidden" name="radius_search_lat<?php
    echo $renderOrder; ?>" value="<?php
    echo $lat; ?>"/>
    <input type="hidden" name="radius_search_lon<?php
    echo $renderOrder; ?>" value="<?php
    echo $lon; ?>"/>
    <table class="table">
        <tr>
            <th><?php
                echo JText::_('PLG_LIST_RADIUS_LOOKUP_NAME'); ?></th>
            <th><?php
                echo JText::_('PLG_LIST_RADIUS_DISTANCE'); ?></th>
            <th><?php
                echo JText::_('PLG_LIST_RADIUS_LOOKUP_VISIBLE'); ?></th>
        </tr>
