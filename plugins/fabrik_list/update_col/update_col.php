...
class PlgFabrik_ListUpdate_col extends PlgFabrik_List
{
    ...
    protected function getUpdateCols($params)
    {
        ...
        elseif ($params->get('update_user_select', 0))
        {
            ...
            $values = FArrayHelper::getValue($output, 'fabrik___filter', []);
            $values = FArrayHelper::getValue($values, $key, []);
    ...
    protected function userSelectForm()
    {
        ...
        foreach ($elementModels as $elementModel)
        {
             ...
             */
            if (
                is_object($selectElements) && isset($selectElements->update_user_select_elements_list) && !in_array($element->id,
                    $selectElements->update_user_select_elements_list)
            )
            {
                continue;
            }
