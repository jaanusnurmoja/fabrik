                ...
                <table class="filtertable table table-striped">
                    ...
                    <tr>
                        <th style="text-align:left"><?php
                            echo FText::_('PLG_VISUALIZATION_FULLCALENDAR_SEARCH'); ?>:
                        </th>
                        <th style="text-align:right"><a href="#" class="clearFilters"><i class="icon-refresh"></i> <?php
                                echo FText::_('PLG_VISUALIZATION_FULLCALENDAR_CLEAR'); ?></a></th>
                    </tr>
                    <?php
                    $c = 0;
                    foreach ($filters
                    ...
                    <tr>
                        <th colspan='2' style="text-align:right;">
                            <button type="submit" class="btn btn-info">
                                <i class="icon-filter"></i> <?php
                                echo FText::_('PLG_VISUALIZATION_FULLCALENDAR_GO') ?>
                            </button>
                        </th>
                    </tr>
                    </tfoot>
