...
class FabrikModelNvd3_Chart extends FabrikFEModelVisualization
{
    ...
    protected function singleLineData()
    {
        ...
        $query->select([$db->qn($xCol) . ' AS x ', $db->qn($yCol) . ' AS y'])->from($table);
        ...
        $colors = explode(',',
            $params->get('colours', '#B9C872,#88B593,#388093,#994B89,#ED5FA2,#4D1018,#8F353E,#D35761,#43574E,#14303C'));
        $return = [];
        $i = 0;
    ...
    {
        $allowed = ['stackedAreaChart', 'multiBarChart', 'lineWithFocusChart', 'multiBarHorizontalChart'];
        $params = $this->getParams();
    ...
    public function js()
    {
        ...
        if (!empty($rawData) && !isset($rawData[0]->color))
        {
            ...
            $colors = explode(',', $params->get('colours',
                '#B9C872,#88B593,#388093,#994B89,#ED5FA2,#4D1018,#8F353E,#D35761,#43574E,#14303C'));
