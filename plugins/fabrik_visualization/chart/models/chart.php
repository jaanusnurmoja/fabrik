...
class FabrikModelChart extends FabrikFEModelVisualization
{
    ...
    public function getChart()
    {
        ...
        $this->calc_prefixmap = ['sum___' => 'sums', 'avg___' => 'avgs', 'med___' => 'medians', 'cnt___' => 'count'];
    ...
    private function getTableData()
    {
        if (!isset($this->tableData))
        {
            ...
            foreach ($listid as $lid)
            {
                ...
                $this->tableData[$c] = ['id' => $lid, 'data' => $alldata, 'cals' => $cals, 'model' => $listModel];
                $c++;
            }
        }
    ...
    private function getAxisLabels($total)
    {
        ...
        if ($calcfound)
        {
            if (!empty($calculationLabels))
            {
                ...
                $glabels = [implode('|', array_reverse($calculationLabels))];
            }
        }
    ...
    protected function pieChart($c, $gdata, $gsums)
    {
        ...
        return [$chd, $chxl, $chds, $fillGraphs];
    }
