...
class FabrikViewCalendar extends JViewLegacy
{
    ...
    public function display($tpl = 'default')
    {
        ...
        $options->days = [
            FText::_('SUNDAY'), FText::_('MONDAY'), FText::_('TUESDAY'), FText::_('WEDNESDAY'), FText::_('THURSDAY'),
            FText::_('FRIDAY'), FText::_('SATURDAY')
        ];
        $options->shortDays = [
            FText::_('SUN'), FText::_('MON'), FText::_('TUE'), FText::_('WED'), FText::_('THU'), FText::_('FRI'),
            FText::_('SAT')
        ];
        $options->months = [
        ...
        $options->shortMonths = [
            FText::_('JANUARY_SHORT'), FText::_('FEBRUARY_SHORT'), FText::_('MARCH_SHORT'), FText::_('APRIL_SHORT'),
    ...
    public function chooseaddevent()
    {
        ...
        $this->_eventTypeDd = JHTML::_('select.genericlist', $options, 'event_type', $attribs, 'value', 'text', '',
            'fabrik_event_type');
