...
if ($this->showFilters) :
    ?>
    <form method="post" action="" name="filter" action="<?php
                ...
                <table class="filtertable fabrikTable fabrikList">
                    ...
                    <tr>
                        <th colspan="2" style="text-align:right;">
                            <?php
                            // Needed when rendered as a J content plugin - otherwise it defaults to 1 each time
                            ?>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right"><a href="#" class="clearFilters"><?php
                                echo FText::_('COM_FABRIK_CLEAR'); ?></a></th>
                    </tr>
                    <?php
                    $c = 0;
