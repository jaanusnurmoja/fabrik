...
elseif ($this->params->get('slideshow_viz_height', '300') === '0')
{
...
<style>
     ...
     */
    .slider img {
    <?php echo $height; ?><?php echo $width; ?>
    }
...
echo $this->containerId; ?>" class="fabrik_visualization">
    ...
    <div class="slideshow" id="slideshow_viz_<?php
    echo $row->id; ?>">
        <div class="slider_loading">
            <div class="slider_loader">
                ...
                <p/>
                <?php
                echo FText::_('PLG_VISUALIZATION_SLIDESHOW_LOADING_MSG'); ?>
            </div>
        </div>
        ...
        <div class="slider" style="margin:auto;">
            ...
            foreach ($this->slideData as $slide):
                ...
                <figure class="image">
                    <?php
                    if ($this->params->get('slideshow_viz_links', '0') === '1'):
                    ...
                    echo $slide['href']; ?>"/>
                    <?php
                    if ($this->params->get('slideshow_viz_links', '0') !== '0'):
                        echo '</a>';
                    endif; ?>
                    <figcaption>
                        <?php
