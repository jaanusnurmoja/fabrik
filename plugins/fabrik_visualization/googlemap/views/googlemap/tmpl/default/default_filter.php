                ...
                <table class="filtertable fabrikTable fabrikList">
                    ...
                    <tr>
                        ...
                        <th style="text-align:right"><a href="#" class="clearFilters"><?php
                                echo FText::_('PLG_VISUALIZATION_GOOGLEMAP_CLEAR'); ?></a></th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        <th colspan="2" style="text-align:right;">
                            <input type="submit" class="fabrik_filter_submit button" value="<?php
                            echo FText::_('PLG_VISUALIZATION_GOOGLEMAP_GO') ?>"/>
                        </th>
                    </tr>
                    </tfoot>
