...
class PlgFabrik_FormEmail extends PlgFabrik_Form
{
    ...
    public function onAfterProcess()
    {
        ...
        @list($emailFrom, $emailFromName) = explode(":",
            $w->parseMessageForPlaceholder($params->get('email_from'), $this->data, false), 2);
        ...
        @list($returnPath, $returnPathName) = explode(":",
            $w->parseMessageForPlaceholder($params->get('return_path'), $this->data, false), 2);
        ...
        foreach ($emailTo as $email)
        {
            ...
            {
                $this->app->enqueueMessage(Text::sprintf('PLG_FORM_EMAIL_DID_NOT_SEND_EMAIL_INVALID_ADDRESS', $email),
                    'notice');
            }
        }
