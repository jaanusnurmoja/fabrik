 ...
 * @updated 10/19/2010
 *
 * If you use this, all I ask is that you let me know! I'd like to see who all uses this! No credits necessary
 *
 * Please note, in $types there are duplicate entries -- it's up to you to determine what type of file is what for duplicates.
 * I would have done this, but in some cases, I could have been incorrect. If duplicates aren't removed, the last occurances will take precedence, even when displaying the list.
 * Reason being, if the key has been set already, it will overwrite that key.
 *
 * Oh, and, if you happen to add onto this list, please email me robertark[-at-]gmail[-dot-]com and I'll add it to the package @ phpclasses!
 *
 * Thanks, Robert
 */
$types = [
