...
(function () {
    ...
    var options, mediaArray, activeMedia, prevMedia, nextMedia, top, mTop, left, mLeft, winWidth, winHeight, fx,
...
//		if (Browser.Platform.ios && (mediaType == "obj" || mediaType == "qt" || mediaType == "html")) mediaType = "ios";
        ...
        if (mediaType == "img") {
            ...
            if (options.imgBackground) {
                ...
                if (options.clickBlock) preload.addEvent('mousedown', function (e) {
                    e.stop();
