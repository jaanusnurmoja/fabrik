...
echo $action ?>" method="post" name="adminForm" id="fabrik-form" class="form-validate">
    ...
    ?>
    <h2><?php
        echo JText::sprintf('COM_FABRIK_CSV_IMPORT_HEADING', $this->listName); ?></h2>
    <?php
    ...
    echo FText::_('COM_FABRIK_IMPORT_CSV') ?>"/>
</form>
