...
#{$view}_$c h3.legend{
	...
	zoom: 1;
	width:100%;
	background: -moz-linear-gradient(center top , #FEFEFE, #EDEDED) repeat scroll 0 0 #E7E7E7;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#EDEDED', endColorstr='#FEFEFE'); /* for IE */
...
#form_$c select#join___942___jem_events_occur___jem_types_id_$i{
max-width:70px;
}
...
#{$view}_$c table.fabrikList th{
	background: -moz-linear-gradient(center top , #FEFEFE, #EDEDED) repeat scroll 0 0 #E7E7E7;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#EDEDED', endColorstr='#FEFEFE'); /* for IE < 10*/
	background: -webkit-gradient(linear, left top, left bottom, from(#FEFEFE),
		to(#EDEDED) );
	background-image: -ms-linear-gradient(top, #FEFEFE, #EDEDED);
}
...
#details_$c table.fabrikList .oddRow0 {
	background-color: #FCFCFC;
}

#details_$c table.fabrikList .oddRow1 {
	background-color: #F9F9F9;
}
...
#{$view}_$c .fabrikNotice{
	background: url('images/alert.png') no-repeat scroll 10px center #FFFEEE !important;
    color: #009FBF;
