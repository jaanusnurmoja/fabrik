...
#{$view}_$c div .fabrikform .fabrikdetails{
	padding:5px;
}
...
#{$view}_$c .fabrikelementcontainer .checkbox,
#{$view}_$c .fabrikelementcontainer .yesno{
	list-style:none;
}
...
#{$view}_$c .fabrikSubElementContainer ul,
#{$view}_$c ul .fabrikRepeatData,
#{$view}_$c .fabrikRepeatData{
	list-style:none;
...
#{$view}_$c div .fabrikSubGroupElements{
	width:80%;
	border: 1px dotted #666;
	/* float:left; */
}

#{$view}_$c tr .fabrikSubGroupElements{
