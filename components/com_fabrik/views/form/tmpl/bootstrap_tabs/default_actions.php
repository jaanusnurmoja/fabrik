...
if ($this->hasActions) : ?>
    <div class="fabrikActions form-actions">
        <div class="row-fluid">
            <div class="<?php
            echo FabrikHelperHTML::getGridSpan(4); ?> btn-group">
                <?php
            ...
            if ($form->customButtons): ?>
                <div class="fabrikCustomButtons <?php
                echo FabrikHelperHTML::getGridSpan(2); ?>">
                    <div class="btn-group">
                        <?php
                        echo $form->customButtons; ?>
                    </div>
                </div>
            <?php
            endif; ?>
            ...
            if ($form->gobackButton || $form->resetButton || $form->deleteButton || $form->clearMultipageSessionButton): ?>
                <div class="<?php
                echo FabrikHelperHTML::getGridSpan(2); ?>"><!-- No Page buttons --></div>
                <div class="<?php
