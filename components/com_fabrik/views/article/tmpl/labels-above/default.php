...
if ($this->params->get('show_page_heading', 1)) { ?>
    ...
    echo $this->params->get('pageclass_sfx') ?>"><?php
        echo $this->escape($this->params->get('page_heading')); ?></div>
<?php
} ?>
<?php
$form = $this->form;
?>
    ...
    echo $form->formid; ?>">
        ...
        {
            ?>
            <fieldset class="fabrikGroup" id="group<?php
                                ...
                                <div class="fabrikGroupRepeater">
                                    ...
                                    <a class="deleteGroup" href="#">
                                        ...
                                        echo FabrikHelperHTML::image('minus', 'form', $this->tmpl,
                                            FText::_('COM_FABRIK_DELETE_GROUP')); ?>
                                    </a>
                                </div>
                            <?php
                            } ?>
        ...
        <div class="fabrikActions"><?php
            echo $form->resetButton; ?><?php
            echo $form->submitButton; ?>
            <?php
            echo $form->copyButton . " " . $form->gobackButton . ' ' . $this->message ?>
        </div>
    </div>
<?php
