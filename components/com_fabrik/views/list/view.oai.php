...
class FabrikViewList extends FabrikViewListBase
{
    ...
    public function display($tpl = null)
    {
        ...
        if ($total === 0)
        {
            echo $this->model->generateError(['code' => 'noRecordsMatch', 'msg' => 'No records matched']);
        }
    ...
    private function rowRights($row)
    {
        ...
        $this->oaiModel->nodeAttributes($rightsReference, ['ref' => $this->params->get('open_archive_license')]);
