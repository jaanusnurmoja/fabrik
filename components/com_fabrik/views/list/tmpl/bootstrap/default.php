...
if ($this->tablePicker != '') : ?>
    <div style="text-align:right"><?php
        echo FText::_('COM_FABRIK_LIST') ?>: <?php
        echo $this->tablePicker; ?></div>
<?php
endif;
...
echo $this->table->action; ?>" method="post" id="<?php
echo $this->formid; ?>" name="fabrikList">
    ...
    <div class="fabrikDataContainer">
        ...
        ?>
        <table class="<?php
        echo $this->list->class; ?>" id="list_<?php
        echo $this->table->renderid; ?>">
            ...
            if ($this->isGrouped && empty($this->rows)) :
                ...
                <tr class="groupDataMsg">
                    <td class="emptyDataMessage" style="<?php
                    echo $this->emptyStyle ?>" colspan="<?php
                    echo count($this->headings) ?>">
            ...
            foreach ($this->rows as $groupedBy => $group) :
                if ($this->isGrouped) : ?>
                    ...
                    <tr class="fabrik_groupheading info">
                        ...
                        echo $this->colCount; ?>">
                            <?php
                            echo $this->layoutGroupHeading($groupedBy, $group); ?>
                        </td>
                    </tr>
                    </tbody>
                <?php
                ...
                <tr class="groupDataMsg" style="<?php
                echo $this->emptyStyle ?>">
                    <td class="emptyDataMessage" style="<?php
                    echo $this->emptyStyle ?>" colspan="<?php
                    echo count($this->headings) ?>">
                    ...
                    <tr class="fabrik_calculations">
                        ...
                        foreach ($this->headings as $key => $heading) :
                            ...
                            echo $style ?>>
                                ...
                                echo array_key_exists($groupedBy,
                                    $cal->grouped) ? $cal->grouped[$groupedBy] : $cal->calc;
                                ?>
                            </td>
                        <?php
                        endforeach;
