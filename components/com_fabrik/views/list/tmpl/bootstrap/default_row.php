...
{ ?>
    <tr id="<?php
    echo $this->_row->id . '_intro'; ?>" class="<?php
    echo $this->_row->class; ?>">
        <td colspan="<?php
        echo count($this->headings); ?>"><?php
            echo $this->_row->data->$rowintro; ?></td>
    </tr>
<?php
} ?>
...
echo $this->_row->class; ?>">
    ...
    foreach ($this->headings as $heading => $label)
    {
        ...
        if ($showCell == true)
        {
            $rowspans = isset($this->rowSpans) ? $this->rowSpans[$heading][$tr][$pkValue] : [];
        ...
        if ($showCell)
        {
            ?>
            <td class="<?php
            echo $this->cellClass[$heading]['class'] ?>" <?php
            echo $rowspan; ?><?php
            echo $style ?>>
                <?php
                echo isset($this->_row->data) ? $v : ''; ?>
            </td>
            <?php
        }
    }
