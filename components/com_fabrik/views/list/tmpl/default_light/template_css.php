...
#listform_$c tfoot td{
	background: -moz-linear-gradient(center top , #FEFEFE, #E9E9E9) repeat scroll 0 0 #E7E7E7;
...
#listform_$c .fabrik_groupheading td{
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#E9E9E9', endColorstr='#FEFEFE'); /* for IE */
}
