    ...
    foreach ($this->elements as $element) :
        if (isset($element->plugin) && ($element->plugin == 'fileupload' || $element->plugin == 'image') && $element->element_raw != '') :
            ...
            if ($element->startRow) : ?>
                ...
                echo $single ? 'fabrikElementContainer' : ''; ?>" <?php
                echo $style ?>><!-- start element row -->
                <?php
                $rowStarted = true;
            endif;
            $style = $element->hidden ? 'style="display:none"' : '';
    ...
    <div class="row-striped">
        ...
        foreach ($this->elements as $element) :
            if (isset($element->plugin) && $element->plugin != 'fileupload' && $element->plugin != 'image') :
                ...
                if ($single)
                {
                    $this->element->containerClass = str_replace('fabrikElementContainer', '',
                        $this->element->containerClass);
                }
                ...
                if ($element->startRow) : ?>
                    <div class="row-fluid <?php
                    echo $single ? 'fabrikElementContainer ' : '';
                    echo $single && $element->dataEmpty ? 'fabrikDataEmpty ' : ''; ?>" <?php
                    echo $style ?>><!-- start element row -->
                    <?php
                    $rowStarted = true;
                endif;
