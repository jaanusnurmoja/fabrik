                ...
                <div class="fabrikGroupRepeater pull-right btn-group">
                    ...
                    if ($group->canAddRepeat) : ?>
                        <a class="addGroup btn btn-small btn-success" href="#">
                            <i class="icon-plus fabrikTip tip-small" opts="{trigger: 'hover'}" title="<?php
                            echo FText::_('COM_FABRIK_ADD_GROUP'); ?>"></i>
                        </a>
                    <?php
                    endif;
                    if ($group->canDeleteRepeat) :?>
                        <a class="deleteGroup btn btn-small btn-danger" href="#">
                            <i class="icon-minus fabrikTip tip-small" opts="{trigger: 'hover'}" title="<?php
                            echo FText::_('COM_FABRIK_DELETE_GROUP'); ?>"></i>
                        </a>
                    <?php
                    endif; ?>
                </div>
