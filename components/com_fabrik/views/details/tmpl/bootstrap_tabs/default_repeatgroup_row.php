        ...
        <td class="fabrikGroupRepeater">
            <div class="pull-right">
                ...
                if ($group->canAddRepeat) :
                    $add = FabrikHelperHTML::image('plus', 'form', $this->tmpl,
                        ['class' => 'fabrikTip tip-small', 'title' => FText::_('COM_FABRIK_ADD_GROUP')]);
                    ?>
                    <a class="addGroup" href="#"><?php
                        echo $add ?></a>
                <?php
                endif;
                if ($group->canDeleteRepeat) :?>
                    <a class="deleteGroup" href="#">
                        ...
                        echo FabrikHelperHTML::image('minus', 'form', $this->tmpl,
                            ['class' => 'fabrikTip tip-small', 'title' => FText::_('COM_FABRIK_DELETE_GROUP')]); ?>
                    </a>
                <?php
                endif; ?>
            </div>
