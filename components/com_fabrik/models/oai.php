...
class FabrikFEModelOai extends FabModel
{
    ...
    public function root()
    {
        ...
        $oai->setAttributeNS('http://www.w3.org/2001/XMLSchema-instance', 'schemaLocation',
    ...
    {
        $uri = Juri::getInstance()->toString(['scheme', 'host', 'path']) . '?option=com_fabrik&controller=oai&format=oai';
    ...
    public function repositoryIdentifier()
    {
        ...
        return $config->get('oai_repository_identifier',
            Juri::getInstance()->toString(['host']));
    }
    ...
    public function generateError($err)
    {
        ...
        $this->nodeAttributes($error, ['code' => $err['code']]);
    ...
    public function resumptionToken($total, $filter)
    {
        ...
        $this->nodeAttributes($token, ['completeListSize' => $total, 'cursor' => $limitStart]);
    ...
    public function identity()
    {
        ...
        $this->nodeAttributes($request, ['verb' => 'Identify']);
    ...
    public function getRecord()
    {
        ...
        $root->appendChild($this->responseDate());
        $request = $this->requestElement();
        $this->nodeAttributes($request, [
            'verb'           => 'GetRecord', 'identifier' => $this->recordIdentifier(),
    ...
    public function listSets()
    {
        ...
        $root->appendChild($this->responseDate());
        $request = $this->requestElement();
        $this->nodeAttributes($request, ['verb' => 'ListSets']);
        $root->appendChild($request);
    ...
    public function listMetaDataFormats($identifier = '')
    {
        ...
        $root->appendChild($this->responseDate());
        $request = $this->requestElement();
        $this->nodeAttributes($request, ['verb' => 'ListMetadataFormats', 'identifier' => $identifier]);
        $root->appendChild($request);
